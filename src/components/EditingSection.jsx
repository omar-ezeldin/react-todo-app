...
export function EditingSection() {
    ...
    const [[tasks, currTaskID], [_setCurrTaskID, _addTask, editTask, deleteTask]] = useTaskContext()
        ...
        <div className={`editing-section ${darkTheme ? "dark" : "light"}`}>
            ...
            <div className="editing-section-body">
                ...
                <div className="input-group completed">
                    ...
                    <div onClick={() => editTask(currTaskID, "isCompleted", !currTask.isCompleted)} className={`checkbox ${darkTheme ? "dark" : "light"}`}>
